...
public class LayoutRevisionPersistenceImpl
	 ...
	 */
	@Override
	public List<LayoutRevision> findByP_I(long plid, long iconImageId) {
		return findByP_I(
			plid, iconImageId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<LayoutRevision> findByP_I(
		long plid, long iconImageId, int start, int end) {

		return findByP_I(plid, iconImageId, start, end, null);
	}
	...
	public List<LayoutRevision> findByP_I(
		...
		return findByP_I(
			plid, iconImageId, start, end, orderByComparator, true);
	}
	...
	public List<LayoutRevision> findByP_I(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				...
				finderArgs = new Object[] {plid, iconImageId};
			}
		}
		else if (useFinderCache) {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_P_I_PLID_2);
	 ...
	 */
	@Override
	public LayoutRevision findByP_I_First(
			long plid, long iconImageId,
			OrderByComparator<LayoutRevision> orderByComparator)
		throws NoSuchLayoutRevisionException {

		LayoutRevision layoutRevision = fetchByP_I_First(
	 ...
	 */
	@Override
	public LayoutRevision fetchByP_I_First(
		long plid, long iconImageId,
		OrderByComparator<LayoutRevision> orderByComparator) {

		List<LayoutRevision> list = findByP_I(
			plid, iconImageId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public LayoutRevision findByP_I_Last(
			long plid, long iconImageId,
			OrderByComparator<LayoutRevision> orderByComparator)
		throws NoSuchLayoutRevisionException {

		LayoutRevision layoutRevision = fetchByP_I_Last(
			plid, iconImageId, orderByComparator);
	 ...
	 */
	@Override
	public LayoutRevision fetchByP_I_Last(
		long plid, long iconImageId,
		OrderByComparator<LayoutRevision> orderByComparator) {

		int count = countByP_I(plid, iconImageId);
		...
		List<LayoutRevision> list = findByP_I(
			plid, iconImageId, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public LayoutRevision[] findByP_I_PrevAndNext(
		...
		try {
			...
			array[0] = getByP_I_PrevAndNext(
				session, layoutRevision, plid, iconImageId, orderByComparator,
				true);
	...
	protected LayoutRevision getByP_I_PrevAndNext(
		Session session, LayoutRevision layoutRevision, long plid,
		long iconImageId, OrderByComparator<LayoutRevision> orderByComparator,
		boolean previous) {
	 ...
	 */
	@Override
	public void removeByP_I(long plid, long iconImageId) {
		for (LayoutRevision layoutRevision :
				findByP_I(
					plid, iconImageId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	 ...
	 */
	@Override
	public int countByP_I(long plid, long iconImageId) {
		FinderPath finderPath = _finderPathCountByP_I;

		Object[] finderArgs = new Object[] {plid, iconImageId};
	...
	private static final String _FINDER_COLUMN_P_I_PLID_2 =
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByP_I = new FinderPath(
			...
			new String[] {"plid", "iconImageId"}, true);
		...
		_finderPathCountByP_I = new FinderPath(
			...
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"plid", "iconImageId"}, false);
